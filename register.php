...
<html>
	<head>
		<title>CP Tracker: A competitive programming tool</title>
		<meta charset="utf-8" />
    ...
    <body class="subpage">
			<header id="header">
				<div class="inner">
					<a href="home.html" class="logo"><strong>CP TRACKER</strong>: A competitive programming tool </a>
					<nav id="nav">
                    ...
                    <div class="6u$ 12u$(xsmall)">
                        <div class="select-wrapper">
                            <select name="dept" id="dept">
                                ...
                                <option value="Insitute of Information Technology (IIT)">Institute of Information Technology (IIT)</option>
